...
function TButton({
  ...
  if (link) {
    ...
    classes = [...classes, "text-white", "focus:rig-2", "focus:ring-offset-2"];
    ...
    switch (color) {
      ...
      case "green":
        ...
        case "orange":
          classes = [
            ...classes,
            "bg-orange-500",  // Base background color
            "hover:bg-orange-600",  // Darker shade on hover
            "focus:ring-orange-400",  // Ring color on focus
            "text-white",  // Text color
            "border",  // Add a border to define the button more clearly
            "border-orange-500",  // Border color
          ];
          break;
      case "blue":
        classes = [
